...
import entermainment from '../../assets/entertainment.png'
  ...
  return (
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        <div className="shortcut-links">
            ...
            <div className={`side-link ${category===02?"active":""}`} onClick={()=>setCategory(02)}>
            ...
            <div className={`side-link ${category===24?"active":""}`} onClick={()=>setCategory(24)}>
                <img src={entermainment} alt="Entermainment" />
                <p>Entermainment</p>
            </div>
            ...
            <div className="subscribed-link">
                ...
                <div className="side-link">
                    <img src={megan} alt="5-Minute Craft" />
                    <p>5-Minute Craft</p>
                </div>
                <div className="side-link">
